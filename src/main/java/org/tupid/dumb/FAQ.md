...
:trollface:: Why :trollface: with :trollface:'s?
- We :trollface: with a :trollface: and :trollface:, this allows us to :trollface: and :trollface:.
- :trollface: are always :trollface: when :trollface:ing a very :trollface:y situation.
